...
export default function ProductsPage() {
  ...
  return (
    <section className="min-h-screen bg-gradient-to-b from-black via-[#0A0A0A] to-black text-white py-20 px-4 md:px-10">
      <div className="max-w-7xl mx-auto">

        {/* HEADER */}
        <div className="text-center mb-14">
          <p className="text-[#D4AF37] tracking-[0.3em] text-xs uppercase">
            Premium Collection
          </p>

          <h1 className="text-3xl md:text-6xl font-serif mt-3">
            Explore Our <span className="text-[#D4AF37] italic">Products</span>
          </h1>

          <div className="w-28 h-[2px] bg-[#D4AF37] mx-auto mt-5"></div>
        </div>
